...
def about_us():
    tkinter.messagebox.showinfo('About Nirvana Player ',
                                'This is the Music Player System Name -Nirvana Player, built using python Tkinter and pygame '
                                'by Rahul ,Sushma ,Divya .''It is developed in 30th October,2020')
    ...
    if paused:
        ...
        try:
            ...
            tkinter.messagebox.showerror('File not found ',
                                         'Nirvana Player could not find the file . Please check it again.')
